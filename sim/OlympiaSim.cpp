...
OlympiaSim::OlympiaSim(sparta::Scheduler & scheduler,
    ...
    workload_(workload),
    edm_backend_(edm_backend),
    edm_backend_config_(edm_backend_config),
    edm_whisper_bin_(edm_whisper_bin),
    edm_whisper_args_(edm_whisper_args),
    edm_whisper_keep_csv_(edm_whisper_keep_csv),
...
void OlympiaSim::buildTree_()
{
    ...
    edm_backend->setValueFromString(edm_backend_);
    edm_backend_config->setValueFromString(edm_backend_config_);
    edm_whisper_bin->setValueFromString(edm_whisper_bin_);
    edm_whisper_args->setValueFromString(edm_whisper_args_);
    edm_whisper_keep_csv->setValueFromString(edm_whisper_keep_csv_);
