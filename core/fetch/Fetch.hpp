...
namespace olympia
{
    ...
    class Fetch : public sparta::Unit
    {
      ...
      private:
        ...
        sparta::DataOutPort<MemoryAccessInfoPtr> out_fetch_icache_req_{&unit_port_set_,
                                                                       "out_fetch_icache_req"};
        ...
        sparta::DataInPort<InstPtr> in_rob_retire_ack_edm_{&unit_port_set_,
                                                           "in_rob_retire_ack_edm"};

        sparta::DataInPort<InstPtr> in_rob_flush_edm_{&unit_port_set_, "in_rob_flush_edm"};

        sparta::DataInPort<InstPtr> in_lsu_commit_store_edm_{&unit_port_set_,
                                                             "in_lsu_commit_store_edm"};

        sparta::DataInPort<InstPtr> in_lsu_drop_store_edm_{&unit_port_set_,
                                                           "in_lsu_drop_store_edm"};
